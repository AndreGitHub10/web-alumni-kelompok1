        ...
        <nav class="navbar navbar-expand-md navbar-light bg-primary shadow-sm">
            <div class="container">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active text-white" href="{{ url('loker') }}">Info Loker</a>
                        </li>
                         <li class="nav-item">
                          <a class="nav-link active text-white" aria-current="page" href="{{ url('mahasiswa') }}">Data Alumni Mahasiswa</a>
                        </li>
                       
                       <li class="nav-item" >
                          <a class="nav-link active text-white" aria-current="page" href="{{ url('tentang') }}">Tentang Kami</a>
                        </li>

                        @if (Auth::check())
                        <li class="nav-item" >
                          <a class="nav-link active text-white" aria-current="page" href="{{ url('berita') }}">Menu Berita</a>
                        </li>
                        @endif
