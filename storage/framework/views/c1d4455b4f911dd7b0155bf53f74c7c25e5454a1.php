        ...
        <nav class="navbar navbar-expand-md navbar-light bg-primary shadow-sm">
            <div class="container">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active text-white" href="#">Info Loker</a>
                        </li>
                         <li class="nav-item">
                          <a class="nav-link active text-white" aria-current="page" href="<?php echo e(url('mahasiswa')); ?>">Data Mahasiswa</a>
                        </li>
...
<?php /**PATH C:\xampp\htdocs\web-alumni-rpl-master\resources\views/layouts/app.blade.php ENDPATH**/ ?>